...
class MenuAccessSeeder extends Seeder
{
    public function run(): void
    {
        $menus = [
            ...
            ['code' => 'admin_sessions', 'label' => 'Sesi', 'route_name' => 'admin.sessions', 'sort_order' => 11],
            ['code' => 'admin_module_sessions', 'label' => 'Sesi', 'route_name' => 'admin.modules.sessions', 'sort_order' => 12],
            ['code' => 'admin_packages', 'label' => 'Paket', 'route_name' => 'admin.modules.packages', 'sort_order' => 13],
            ['code' => 'admin_subjects', 'label' => 'Mapel', 'route_name' => 'admin.modules.subjects', 'sort_order' => 14],
            ['code' => 'admin_items', 'label' => 'Item', 'route_name' => 'admin.modules.items', 'sort_order' => 15],
            ['code' => 'admin_users', 'label' => 'User', 'route_name' => 'admin.modules.users', 'sort_order' => 16],
            ['code' => 'admin_activity_logs', 'label' => 'Activity Log', 'route_name' => 'admin.activity.logs', 'sort_order' => 17],
            ['code' => 'owner_reports', 'label' => 'Laporan Owner', 'route_name' => 'owner.reports', 'sort_order' => 18],
            ['code' => 'owner_financials', 'label' => 'Financial Owner', 'route_name' => 'owner.financials', 'sort_order' => 19],
            ...
            ['code' => 'superadmin_items', 'label' => 'Item', 'route_name' => 'superadmin.modules.items', 'sort_order' => 22],
            ['code' => 'superadmin_sessions', 'label' => 'Sesi', 'route_name' => 'superadmin.modules.sessions', 'sort_order' => 23],
            ['code' => 'superadmin_users', 'label' => 'User', 'route_name' => 'superadmin.modules.users', 'sort_order' => 24],
            ['code' => 'settings', 'label' => 'Setting Web', 'route_name' => 'superadmin.settings', 'sort_order' => 25],
            ['code' => 'menu_access', 'label' => 'Hak Akses Menu', 'route_name' => 'superadmin.menu.access', 'sort_order' => 26],
            ['code' => 'backup_center', 'label' => 'Backup Restore', 'route_name' => 'superadmin.backup.center', 'sort_order' => 27],
            ['code' => 'import_center', 'label' => 'Import Data', 'route_name' => 'superadmin.import.center', 'sort_order' => 28],
        ];
