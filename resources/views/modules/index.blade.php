        ...
        <div class="modal-overlay is-open">
            ...
            <form method="POST" action="{{ route($routePrefix . '.modules.store', ['module' => $module]) }}" class="section modal-form">
                ...
                @elseif($module === 'sessions')
                    <div class="grid grid-3">
                        <div class="form-group"><input type="datetime-local" class="form-control" name="start_at" value="{{ old('start_at') }}" required></div>
                        <div class="form-group"><input type="datetime-local" class="form-control" name="end_at" value="{{ old('end_at') }}" required></div>
                        <div class="form-group">
        ...
        <div class="modal-overlay is-open">
            ...
            @if($tab === 'active')
                <form method="POST" action="{{ route($routePrefix . '.modules.update', ['module' => $module, 'id' => $detail->id]) }}" class="section modal-form">
                    ...
                    @elseif($module === 'sessions')
                        <div class="grid grid-3">
                            <div class="form-group"><input type="datetime-local" class="form-control" name="start_at" value="{{ old('start_at', optional($detail->start_at)->format('Y-m-d\\TH:i')) }}" required></div>
                            <div class="form-group"><input type="datetime-local" class="form-control" name="end_at" value="{{ old('end_at', optional($detail->end_at)->format('Y-m-d\\TH:i')) }}" required></div>
                            <div class="form-group">
                                <select class="form-control" name="status">
