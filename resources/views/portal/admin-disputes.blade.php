...
@section('title', 'Dispute Center')

@section('content')
<div class="card">
    <h3 class="card-title">Daftar Dispute</h3>
    <p class="card-meta">Update status dan selesaikan dispute operasional.</p>
    ...
    <div class="table-wrap section">
        <table>
            ...
            <tbody>
                        ...
                        <td>
                            <div class="action-stack">
                                ...
                                <form method="POST" action="{{ route('ops.dispute.resolve', $d->id) }}" class="material-inline">
                                    @csrf
                                    <input type="text" name="notes" class="form-control" placeholder="Catatan resolve">
                ...
                @empty
                    <tr><td colspan="6">Belum ada dispute.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
