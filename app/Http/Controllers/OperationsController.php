...
class OperationsController extends Controller
{
    ...
    public function bookSlot(Request $request)
    {
        ...
        try {
            $session = $this->sessionSlotService->bookForStudent(
                (int) auth()->id(),
        ...
        $this->auditService->log('SLOT_BOOKED_BY_STUDENT', $session, [], [
            'slot_id' => $validated['slot_id'],
            'subject_id' => $validated['subject_id'],
        ]);

        return back()->with('status', 'Sesi berhasil dibooking. Tentor sudah ditentukan.');
    }
